/*
 * Copyright (c) 2020-2023 Aspeed Technology Inc.
 *
...
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_cs), SPIM1CSIN, SPIM1CSOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_in_default), SPIM1CLKIN, SPIM1MOSIIN, SPIM1MISOIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_out_default), SPIM1CLKOUT, SPIM1MOSIOUT, SPIM1MISOOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_qspi_in_default), SPIM1IO2IN, SPIM1IO3IN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_qspi_out_default), SPIM1IO2OUT, SPIM1IO3OUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_rst_in), SPIM1SPIRSTIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_rst_out), SPIM1SPIRSTOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_muxsel), SPIM1MUXSEL)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim2), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_cs), SPIM2CSIN, SPIM2CSOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_in_default), SPIM2CLKIN, SPIM2MOSIIN, SPIM2MISOIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_out_default), SPIM2CLKOUT, SPIM2MOSIOUT, SPIM2MISOOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_qspi_in_default), SPIM2IO2IN, SPIM2IO3IN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_qspi_out_default), SPIM2IO2OUT, SPIM2IO3OUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_rst_in), SPIM2SPIRSTIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_rst_out), SPIM2SPIRSTOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_muxsel), SPIM2MUXSEL)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim3), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_cs), SPIM3CSIN, SPIM3CSOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_in_default), SPIM3CLKIN, SPIM3MOSIIN, SPIM3MISOIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_out_default), SPIM3CLKOUT, SPIM3MOSIOUT, SPIM3MISOOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_qspi_in_default), SPIM3IO2IN, SPIM3IO3IN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_qspi_out_default), SPIM3IO2OUT, SPIM3IO3OUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_rst_in), SPIM3SPIRSTIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_rst_out), SPIM3SPIRSTOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_muxsel), SPIM3MUXSEL)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim4), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_cs), SPIM4CSIN, SPIM4CSOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_in_default), SPIM4CLKIN, SPIM4MOSIIN, SPIM4MISOIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_out_default), SPIM4CLKOUT, SPIM4MOSIOUT, SPIM4MISOOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_qspi_in_default), SPIM4IO2IN, SPIM4IO3IN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_qspi_out_default), SPIM4IO2OUT, SPIM4IO3OUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_rst_in), SPIM4SPIRSTIN)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_rst_out), SPIM4SPIRSTOUT)
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_muxsel), SPIM4MUXSEL)
#endif
