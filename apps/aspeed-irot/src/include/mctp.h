...
#define MCTP_RX_TASK_STACK_SIZE 8192
#define MCTP_TX_TASK_STACK_SIZE 8192
...
/* ipc config for mctp medium_conf */
typedef struct _mctp_ipc_conf {
	uint8_t id;
	uint8_t rsz;
} mctp_ipc_conf;
